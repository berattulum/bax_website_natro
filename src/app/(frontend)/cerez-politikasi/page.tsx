...
export default function CookiePolicyPage() {
  return (
    ...
    >
      <LegalSection title="Politikanın amacı">
      ...
      <LegalSection title="Çerez türleri">
      ...
      <LegalSection title="Kullanım amaçları ve aktarım">
      ...
      <LegalSection title="Çerez tercihlerini yönetme">
      ...
      <LegalSection title="İlgili kişi hakları">
