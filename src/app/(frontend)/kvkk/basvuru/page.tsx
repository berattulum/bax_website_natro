...
export default function KvkkApplicationPage() {
  return (
    ...
    >
      <LegalSection title="Formun amacı">
      ...
      <LegalSection title="Başvuru yöntemleri">
        <div className="legal-methods">
          <article><h3>Şahsen başvuru</h3><p>Kimliğinizi doğrulayan belgelerle şirket adresine şahsen başvurabilirsiniz.</p></article>
          <article><h3>Noter veya iadeli taahhütlü posta</h3><p>Başvuru evrakınızı noter aracılığıyla veya teslimatı kanıtlanabilir posta yöntemiyle iletebilirsiniz.</p></article>
          <article><h3>Kayıtlı e-posta adresi</h3><p>Şirket sisteminde daha önce kayıtlı ve size ait olduğu doğrulanabilen e-posta adresinizden info@baxcomposites.com adresine başvurabilirsiniz.</p></article>
        </div>
      ...
      <LegalSection title="Başvuruda bulunması gereken bilgiler">
        <ul>
          <li>Ad ve soyadı</li>
      ...
      <LegalSection title="Yanıt ve bildirim">
      ...
      <LegalSection title="Formu doldurma">
