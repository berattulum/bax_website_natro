...
export default function SiteClient({
  ...
  locales: Locales
  narratives?: Record<Lang, HomeNarratives>
}) {
  ...
  const homeNarratives = narratives?.[lang] || homeNarrativesCopy[lang]
  const { loco3Process, capabilityTransition, sectorApplications, verificationEvidence, engineeringCards, sliderControl } = homeNarratives
