  ...
  return <>
    ...
    <header className="main-header">
      <div className="container header-container">
        <div className="logo"><a href="#home" aria-label="BaX Composites"><img className="brand-logo brand-logo-header" src="/brand/bax-composites-original.svg" alt="BaX Composites" /></a></div>
