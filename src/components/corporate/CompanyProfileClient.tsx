  ...
  return (
    <main className="profile-page">
      ...
      <section className="profile-intro">
        ...
        <div className="profile-intro-copy"><span className="profile-kicker">{text.who}</span><h2>{d.aboutTitle?.replace(/<br\s*\/?>/gi, ' ')}</h2><p className="profile-lead">{d.aboutDescription}</p><p>{d.aboutGoal}</p></div>
      </section>
